...
from tensorflow.keras.layers import Dense, LeakyReLU, ELU, BatchNormalization, Dropout #type: ignore
...
history = model.fit(x_train, y_train, validation_split=0.2, epochs=50, batch_size=32, callbacks= [early_stop, reduce_lr])
